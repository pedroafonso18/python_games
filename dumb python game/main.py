...
obsctacle_timer = pygame.USEREVENT + 1
pygame.time.set_timer(obsctacle_timer,1400)
...
while True:
    ...
    # blit essentially means block image transfer, which is a fancy way of saying put image on top of image.
        ...
        obsctacle_rect_list = obstacle_movement(obsctacle_rect_list)
